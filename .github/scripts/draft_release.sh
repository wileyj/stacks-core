...
if [[ "${RELEASE_TYPE}" == "stacks-signer" ]]; then
    ...
    companion_line="The version of stacks-node compatible with this release is ${node_tag}, available here: https://github.com/stacks-network/stacks-core/releases/tag/${node_tag}."
else
    node_tag="${VERSION}"
    signer_tag="${node_tag}.0"
    companion_line="The version of stacks-signer compatible with this release is ${signer_tag}, available at: https://github.com/stacks-network/stacks-core/releases/tag/signer-${signer_tag}."
fi
...
if [[ "${RELEASE_TYPE}" == "stacks-signer" ]]; then
    ...
    changelog_link="https://github.com/stacks-network/stacks-core/blob/${node_tag}/CHANGELOG.md"
fi
